    ...
    <div className="w-full space-y-6">
      ...
      <div className="grid w-full gap-6">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
          ...
          <div className="h-full sm:col-span-2">{/* <GardenOverview /> */}</div>

          {/* Weather takes 1/3 width on small screens and up */}
          <div className="sm:col-span-1">{/* <WeatherWidget /> */}</div>
        </div>

        {/* Second row: Tasks at full width */}
        <div className="w-full">{/* <TaskChecklist /> */}</div>
        ...
        <div className="w-full">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                AI-powered suggestions for your gardens
              </CardDescription>
            </CardHeader>
            <CardContent>{/* <GardenRecommendations /> */}</CardContent>
          </Card>
        </div>
      </div>
    </div>

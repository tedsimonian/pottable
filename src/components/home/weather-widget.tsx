      ...
      <CardContent>
        ...
        <div className="grid grid-cols-3 gap-2 text-center">
          <div className="rounded-lg bg-gray-50 p-2">
            ...
            <p className="text-primary-foreground text-xs font-medium">30%</p>
          ...
          <div className="rounded-lg bg-gray-50 p-2">
            ...
            <p className="text-primary-foreground text-xs font-medium">75°F</p>
          ...
          <div className="rounded-lg bg-gray-50 p-2">
            ...
            <p className="text-primary-foreground text-xs font-medium">5 mph</p>

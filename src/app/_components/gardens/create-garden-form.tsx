...
const defaultValues: Partial<GardenFormValues> = {
  name: "",
  description: "",
  location: "backyard",
  directionality: "east", // Changed from south to east
  sunExposure: "partial",
...
export function CreateGardenForm() {
  ...
  function onSubmit(data: GardenFormValues) {
    ...
    setTimeout(() => {
      ...
      // Redirect to the gardens list page after successful creation
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Set up your garden space with details that will help our AI provide personalized recommendations.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
